...
//		System.out.println(jsonpObject.getValue().g.toString());
		Result result2 = JsonUtil.readValue(result, Result.class);
		System.out.println(result2.toString());
    }
	 /*
     * 发送POST请求
     */
	public Result sendPost(String img1, String img2) throws Exception {
        ...
        int statusCode = 200;
        try {
            URL realUrl = new URL(faceRecognConfig.getUrl());
            /*
             * http header 参数
             */
            String method = "POST";
